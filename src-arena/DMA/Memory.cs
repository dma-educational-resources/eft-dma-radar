...
namespace eft_dma_radar.Arena.DMA
{
    internal static class Memory
    {
        ...
        private static void RunStartupLoop()
        {
            ...
            while (!_shutdown)
            {
                try
                {
                    ...
                    uint cachedAllCamerasRva  = eft_dma_radar.Arena.Unity.UnityOffsets.AllCameras;
                    uint cachedGomFallbackRva = eft_dma_radar.Arena.Unity.UnityOffsets.GomFallback;
                    uint cachedCamViewMatrix  = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.ViewMatrix;
                    uint cachedCamFov         = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.FOV;
                    uint cachedCamAspect      = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.AspectRatio;
                    uint cachedCamDeref       = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.DerefIsAddedOffset;
                    uint cachedTaHier         = eft_dma_radar.Arena.Unity.UnityOffsets.TransformAccess.HierarchyOffset;
                    uint cachedTaIdx          = eft_dma_radar.Arena.Unity.UnityOffsets.TransformAccess.IndexOffset;
                    uint cachedThWorldPos     = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.WorldPositionOffset;
                    uint cachedThWorldRot     = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.WorldRotationOffset;
                    uint cachedThVerts        = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.VerticesOffset;
                    uint cachedThIdx          = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.IndicesOffset;
                    ...
                    // Done BEFORE the UnityPlayer dump so the resolver's "Resolved" column
                    // reflects what the live module actually exposes this run.
                    ...
                    eft_dma_radar.Arena.Unity.UnityPlayerResolver.Configure(
                        new eft_dma_radar.Arena.Unity.UnityPlayerResolver.HostConfig
                        {
                            Memory               = new MemoryAccessAdapter(),
                            GetLiveCamera        = () => eft_dma_radar.Arena.GameWorld.CameraManager.LiveFpsCamera,
                            ReadIl2CppClassName  = klass => eft_dma_radar.Arena.Unity.Il2CppClass.ReadName(klass, useCache: true),
                            ...
                            // sig-scanned this run (post-Initialize).
                            AllCamerasRva            = eft_dma_radar.Arena.Unity.UnityOffsets.AllCameras,
                            GomFallbackRva           = eft_dma_radar.Arena.Unity.UnityOffsets.GomFallback,
                            CameraViewMatrix         = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.ViewMatrix,
                            CameraFov                = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.FOV,
                            CameraAspectRatio        = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.AspectRatio,
                            CameraDerefIsAddedOffset = eft_dma_radar.Arena.Unity.UnityOffsets.Camera.DerefIsAddedOffset,
                            GoObjectClass            = eft_dma_radar.Arena.Unity.UnityOffsets.GO_ObjectClass,
                            GoComponents             = eft_dma_radar.Arena.Unity.UnityOffsets.GO_Components,
                            GoName                   = eft_dma_radar.Arena.Unity.UnityOffsets.GO_Name,
                            CompObjectClass          = eft_dma_radar.Arena.Unity.UnityOffsets.Comp_ObjectClass,
                            CompGameObject           = eft_dma_radar.Arena.Unity.UnityOffsets.Comp_GameObject,
                            TaHierarchyOff           = eft_dma_radar.Arena.Unity.UnityOffsets.TransformAccess.HierarchyOffset,
                            TaIndexOff               = eft_dma_radar.Arena.Unity.UnityOffsets.TransformAccess.IndexOffset,
                            ThWorldPosition          = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.WorldPositionOffset,
                            ThWorldRotation          = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.WorldRotationOffset,
                            ThVertices               = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.VerticesOffset,
                            ThIndices                = eft_dma_radar.Arena.Unity.UnityOffsets.TransformHierarchy.IndicesOffset,
                            ...
                            CachedThWorldPosition       = cachedThWorldPos,
                            CachedThWorldRotation       = cachedThWorldRot,
                    ...
                    eft_dma_radar.Arena.Unity.UnityPlayerResolver.Dump();
        ...
        /// <see cref="eft_dma_radar.Arena.Unity.UnityPlayerResolver"/>.
        /// </summary>
        private sealed class MemoryAccessAdapter : eft_dma_radar.Arena.Unity.UnityPlayerResolver.IMemoryAccess
        {
            ...
            public void Log(string message)             => eft_dma_radar.Arena.Misc.Log.WriteLine(message);
        }
